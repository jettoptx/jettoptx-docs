...
export const MOA_NODES: MoaNode[] = [
  ...
  { id: "hermes-api", label: "Hermes API", group: "astrojoe", agt: "COG", radius: 14, href: "/docs/astrojoe/api", description: "Historical Hermes OPTX API bridge — deprecated public mirror", subLabels: ["Deprecated", "SSE Streaming", "Sessions", "Upstream Hermes"], emo: 10, env: 15, cog: 75 },
  { id: "hermes-features", label: "Hermes Features", group: "astrojoe", agt: "COG", radius: 14, href: "/docs/astrojoe/hermes-features", description: "Hermes Agent capabilities — link to upstream NousResearch releases", subLabels: ["Autonomous Curator", "Skill System", "Multi-Provider", "Agent OS"], emo: 10, env: 25, cog: 65 },
  ...
  { id: "depin", label: "DePIN", group: "infrastructure", agt: "ENV", radius: 15, href: "/docs/infrastructure/depin", description: "CSTB Trust attestation and DePIN validator staking on Solana mainnet", subLabels: ["$CSTB Token", "Validator Staking", "Trust Score"], emo: 15, env: 65, cog: 20 },

  { id: "bridge-hub", label: "Bridge Hub", group: "on-chain-bridge", agt: "EMO", radius: 19, href: "/docs/on-chain-bridge", description: "Solana-native on-chain programs — jtx_cstb_trust and jett_vault", subLabels: ["AARON Router", "Solana-Only", "Mainnet Live"], emo: 50, env: 40, cog: 10 },
