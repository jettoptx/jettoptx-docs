...
Hermes Agent ships a large built-in skill library (categories include `software-development`, `devops`, `mcp`, `research`, and more) plus anything installed via the Skills Hub. Count changes with upstream releases � track [hermes-agent releases](https://github.com/NousResearch/hermes-agent/releases) rather than a pinned number in these docs.
...
**Trigger**: User asks about gaze verification, OPTX Auth, or biometric sessions.
