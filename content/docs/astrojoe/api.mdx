...
description: Historical Hermes OPTX API bridge — deprecated public mirror. Active development is private.
---

> **Deprecated.** The public mirror at [jettoptx-hermes-api](https://github.com/jettoptx/jettoptx-hermes-api) is unmaintained. For Hermes Agent capabilities, see upstream [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) releases and [Hermes Features](/docs/astrojoe/hermes-features). Active OPTX integration development is in a private repo.

The **Hermes OPTX API** was a FastAPI sidecar extending [Hermes Agent](https://github.com/NousResearch/hermes-agent) with SSE streaming chat, pluggable memory, and task orchestration endpoints for JettChat.
