---
title: "@jettoptx/auth"
description: OPTX Auth for integrators — It's you. Email, X, or wallet via @jettoptx/auth.
icon: KeyRound
---
...
> **Note:** [jettoptx.chat](https://jettoptx.chat) (DOJO) uses **Privy** as its primary auth provider. Use `@jettoptx/auth` for **custom integrations**. Product name: **OPTX Auth**.
