---
title: "@jettoptx/auth"
description: X OAuth PKCE + Solana signMessage + Ed25519 JWT for custom xChat Native integrations.
icon: KeyRound
---

> **Note:** [jettoptx.chat](https://jettoptx.chat) (DOJO) uses **Privy** as its primary auth provider. Use `@jettoptx/auth` when building **custom integrations** outside the DOJO product — see [JETT Auth](/docs/authentication/jett-auth).
