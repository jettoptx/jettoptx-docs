...
> **Status: Roadmap.** The ERC-8004 soulbound agent wallet is a planned identity layer; no contract is deployed today. Treat code samples below as design intent. For current JettChat auth, see [OPTX Auth](/docs/authentication/optx-auth).
