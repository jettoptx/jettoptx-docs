...
AARON connects **OPTX Auth** (your biometric gaze signature) through the **OPT&#x1D54F;** secure bridge to the public **OPTX** blockchain on Solana. Private compute runs on edge hardware; only opaque proof hashes go on-chain.
...
|------|-----------|-------------|
| **OPTX Auth** | Identity layer | Biometric gaze signature + SSO on the validator node. It's you. |
| **OPT&#x1D54F;** | Optical Program Technologic &#x1D54F;tension | The secure bridge that turns OPTX Auth into verifiable on-chain proofs. |
...
| **AGT** | Agentive Gaze Tensor | Biometric tensor system (COG/EMO/ENV) powering OPTX Auth. |
...
> **DePIN** = Decentralized Physical Infrastructure Network. AARON validates human identity through gaze via **OPTX Auth**, bridges proofs through **OPT&#x1D54F;**, and earns $OPTX on the public network.
