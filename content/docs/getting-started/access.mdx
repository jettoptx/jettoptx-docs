...
| **Wallet-less** | Checkout on [astroknots.space/stake](https://astroknots.space/stake) | Subscription maps to tier codes — see [Access Tiers](/docs/token/tiers) |
| **Higher tiers** | JTX balance or NFT | `mojo` / `dojo` / `spaceCowboy` thresholds in [Access Tiers](/docs/token/tiers) |
