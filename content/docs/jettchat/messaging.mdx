...
- **xChat Native**: TLS to JettChat server + per-conversation E2E encryption.
- **Phantom Mode**: Triple Tor onion + per-conversation post-quantum hybrid encryption.
...
- **Auth** — see [OPTX Auth](/docs/authentication/optx-auth)
- **Token gating** — see [$JTX Token](/docs/token)
