...
| **Asymmetric crypto** | TLS / Ed25519 | Post-quantum hybrid |
...
Session keys use a **hybrid post-quantum construction** combining classical and lattice-based key exchange. Algorithm details are documented in the [Secure-Legion/android](https://github.com/Secure-Legion/android) repository.
