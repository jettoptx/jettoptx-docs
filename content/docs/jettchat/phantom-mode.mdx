...
This same construction is sometimes referred to as **TKDF** in the encryption SDK — TKDF is the SDK-layer name; Secure-Legion is the org-level brand wrapping the primitive plus Tor and hardware key storage.
